...
namespace RPG_game.Model
{
    public class GameStory
    {
        ...
        public GameStory()
        {
            ...
            Locations.Add(25, new Location() { Name = "Kavárna Moonbucks", Description = "Barista si s úsměvem ukáže na jmenovku. \"Jsem Maniel. K vaším službám.\"", RedirectPath = new RedirectPath() { LocationId = 10, PathId = 1, NewNextLocationId = 40 }, Paths = new List<Path>() { new Path() { PathId = 0, PathDescription = "Rozloučit se a odejít", NextLocationId = 5 } } });
            ...
            Locations.Add(30, new Location() { Name = "Kavárna Moonbucks", Description = "Baristka se na tebe zadívá a po chvilce klidně odpoví.\"Maniela. Užijte si kávu. Nashledanou.\"", RedirectPath = new RedirectPath() { LocationId = 10, PathId = 1, NewNextLocationId = 40 }, Paths = new List<Path>() { new Path() { PathId = 0, PathDescription = "Rozloučit se a odejít", NextLocationId = 5 } } });
            ...
            Locations.Add(40, new Location() { Name = "Kavárna Moonbucks", Description = "Nová kavárna", Paths = new List<Path>() { new Path() { PathId = 0, PathDescription = "Zpět na náměstí", NextLocationId = 10 } } });
            ...
            Locations.Add(103, new Location() { Name = "WOW... účes se opravdu povedl", Description = "Tvůj nový účes je vážně skvělý, sluší ti to. 😉", RedirectPath = new RedirectPath() { LocationId = 10, PathId = 2, NewNextLocationId = 120 }, Paths = new List<Path> { new Path() { PathId = 0, PathDescription = "Poděkovat, zaplatit a odejít", NextLocationId = 5 } } });
            ...
            Locations.Add(120, new Location() { Name = "Kadeřnictví u Zohana", Description = "Nové kadeřnictví", Paths = new List<Path>() { new Path() { PathId = 0, PathDescription = "Zpět na náměstí", NextLocationId = 10 } } });
            ...
            Locations.Add(305, new Location() { Name = "Kino Cinnamon", Description = "Kupuješ si lístek na film V síti, kde po menším pádu ze schodů potkáváš velmi sympatickou Lenku, se kterou se během večera zpřátelíš.", PathToLock = new LocationPath() { LocationId = 300, PathId = 1 }, Paths = new List<Path> { new Path() { PathId = 0, PathDescription = "Doprovodit Lenku domů, popřát dobrou noc a odejít", NextLocationId = 5 } } });
